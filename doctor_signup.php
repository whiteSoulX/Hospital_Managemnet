...
function registerDoctor($name, $email, $specialization, $password) {
    $doctorDataFile = 'doctor_data.txt';
    $doctorData = fopen($doctorDataFile, 'a');
    fwrite($doctorData, "$email,$name,$specialization,$password\n");
    fclose($doctorData);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    registerDoctor($name, $email, $specialization, $password);
}
?>
